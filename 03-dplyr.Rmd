...
Grouping doesn't change how the data look, but will change how it works with other dplyr verbs.
The tibble will print with the number of groups in that variable:
...
One of the most common dply verbs `group_by()` is often usedwith is `summarize()`,  which collapses each
